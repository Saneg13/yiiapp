...
class SHDetailView extends CWidget
{
    private $_formatter;
     ...
     * @see itemCssClass
     */
    public $itemTemplate="<tr class=\"{class}\"><th>{label}</th><td><pre class='brush : php'>{value}</pre></td></tr>\n";
    /**
     ...
     */
    public $itemCssClass=array('brush : php','even');
    /**
     * @var array the HTML options used for {@link tagName}
     */
    public $htmlOptions=array('class'=>'sh-detail-view');
    /**
