...
<body>
<div id="text"><img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/test/views/system/img/aboutme.png" alt=""
                    title=""></div>
<div id="stripe"></div>

<div id="about" class="clearfix">

    <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/test/views/system/img/sample/photo.jpg" alt="" title="">
...
<div id="about-middle" class="clearfix">
    ...
    <div id="content-left">
        ...
        <div class="clearfix"><h2>Мои навыки</h2></div>
    ...
    <div id="content-right">
        ...
        <div class="clearfix"><h2>Что я могу делать</h2></div>
